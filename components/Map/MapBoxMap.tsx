...
function MapboxMap() {
  ...
  //   const res = await fetch(
  //     MAPBOX_DRIVING_ENDPOINT +
  //       "79.8541134%2C6.9387469%3B80.6350358%2C7.2931208"+
    ...
    <div className="p-5">
      ...
      <div className="rounded-lg overflow-hidden">
        {userLocation ? (
          <Map
            ref={mapRef}
            mapboxAccessToken={"pk.eyJ1Ijoic2hhZGVlciIsImEiOiJjbHJmeGV0ZWUwOGlwMmlvNjQzMGwwMzk4In0.a2oaT3-DeIvObA60H9Zo9g"}
            initialViewState={{
